  ...
  return (
    <div className="pt-4 pb-4">
      ...
      <div className="flex gap-1 pt-1">
        ...
        <span className="text-zinc-300 text-xs bg-zinc-800 rounded-sm px-2 py-0.5">🔴 HTML</span>
        <span className="text-zinc-300 text-xs bg-zinc-800 rounded-sm px-2 py-0.5">🟣 CSS</span>
      </div>
